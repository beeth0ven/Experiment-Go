...
//    
//    var searthTextDidSelected: ((String?) -> ())?
//    
...
//        return cell
//    }
//    override func tableView(tableView: UITableView, titleForHeaderInSection section: Int) -> String? { return "History" }
//    
...
//        searthTextDidSelected?(selectedText)
//        historyManager.addSearchText(selectedText)
//        tableView.reloadData()
//    }
//    
//    func didDismissSearchController(searchController: UISearchController) { if String.isBlank(searchController.searchBar.text) { searthTextDidSelected?(nil)} }
}
